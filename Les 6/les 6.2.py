   ...
   # lijst.delete(0, tk.END)
    if ControleInvoer():
        try:
            ...
            ToonFoutBoodschap('Ongeldig!', 'Invoer moet een getal zijn, groter dan 0 en kleiner dan 4000.')
            return
...
Waarbij je -- pad naar Tk -- vervangt met het correcte pad naar die file.
