...
tk.Label(venster, text="Voornaam: ").grid(row=0, sticky=tk.W, padx=4)
tk.Entry(venster).grid(row=0, column=1, sticky=tk.E, padx=4, pady=4) # input veld

tk.Label(venster, text="Familienaam: ").grid(row=1, sticky=tk.W, padx=4)
...
tk.Label(venster, text="Bescherijving produkt: ").grid(row=0, column=0, sticky=tk.W)
